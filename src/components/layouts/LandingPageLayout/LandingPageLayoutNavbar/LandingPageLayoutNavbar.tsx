        ...
        <NavbarContent className="hidden lg:flex">
          {NAV_ITEMS.map((item) => (
            <NavbarItem
              ...
              as={Link}
              href={item.href}
              className={cn("text-default-700 hover:text-danger font-medium", {
        ...
        <NavbarItem className="relative hidden lg:flex">
          ...
          {search !== "" && (
            <Listbox
              ...
              className="absolute top-12 right-0 rounded-xl bg-white shadow-md"
            >
        ...
        <NavbarMenu className="gap-4">
            ...
            <NavbarMenuItem key={`nav-${item.label}`}>
              <Link
                className={cn(
                  ...
                  {
                    "text-danger font-bold": router.pathname === item.href,
                  },
                )}
                href={item.href}
              >
          ...
          {session.status === "authenticated" ? (
            <Fragment>
              ...
              <NavbarMenuItem>
                <Link
                  className="text-default-700 hover:text-danger font-medium"
                  href="/member/profile"
                >
                  Profile
                </Link>
