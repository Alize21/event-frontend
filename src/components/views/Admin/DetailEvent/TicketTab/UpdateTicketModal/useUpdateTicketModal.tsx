...
const schema = yup.object().shape({
  ...
  price: yup.string().required("Input category price"),
  quantity: yup.string().required("Input category quantity"),
  description: yup.string().required("Input category description"),
});
...
const useUpdateTicketModal = (id: string) => {
  ...
  const {
    ...
    onSuccess: () => {
      setToaster({
        type: "success",
        message: "Success to update a ticket",
      });
      reset();
    },
  });
